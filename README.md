...
精选的 **107 个** Agent Skills，为 [Pi Agent](https://pi.dev) 量身定制。

## 来源

这些 skills 精选自 [opencode-skills](https://github.com/FuSheng-MG/opencode-skills)（原 OpenCode 生态），
转换为标准的 [Agent Skills](https://agentskills.io/specification) 格式，开箱即用于 Pi Agent。

## 分类

| 分组 | 数量 | 说明 |
|------|------|------|
| agent-skills | 24 | 通用工程全流程（addyosmani） |
...
| infra-deploy | 4 | Cloudflare/Netlify/Vercel/Render |
